...
<div class="form-group">
	...
	<div class="col-sm-8">
		{!! Form::text('name', $banner['name'], ['class' => 'form-control', 'autocomplete' => 'off']) !!}
	</div>
</div>
<div class="form-group">
	{!! Form::label('url', 'URL:', ['class' => 'col-sm-3 control-label']) !!}
	<div class="col-sm-8">
		{!! Form::text('url', $banner['url'], ['class' => 'form-control', 'placeholder' => 'Redirect URL', 'autocomplete' => 'off']) !!}
	</div>
</div>
<div class="form-group">
	{!! Form::label('image', 'Image:', ['class' => 'col-sm-3 control-label']) !!}
	<div class="col-sm-8 image_upload_field">
		{!! Form::text('image', $banner['image'], ['class' => 'form-control', 'placeholder' => 'Insert/upload or paste image url', 'autocomplete' => 'off']) !!}
